...
- Cada bloque largo recibe un hito obligatorio de esa fórmula y sólo se acepta si incluye `viralEvidence`: una cita literal del propio guion donde ese hito realmente ocurrió; los proyectos anteriores se migran automáticamente al motor viral al regenerar
