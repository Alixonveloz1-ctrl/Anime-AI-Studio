...
export function createFixture({empty=false}={}){
 ...
 async function transport(url,options={}){
  ...
  else if(path.endsWith('/develop')){p.developments=[{id:'dev',data,created:1,revision:1,approvalState:'candidate'}];result=job('develop',{});}
