...
http.createServer(async(req,res)=>{
 ...
 if(u.pathname==='/api/shorts'){
  req.query=Object.fromEntries(u.searchParams);res.status=n=>{res.statusCode=n;return res;};res.json=v=>res.end(JSON.stringify(v));res.setHeader('Content-Type','application/json');return require('../../api/shorts.js')(req,res);
 }
